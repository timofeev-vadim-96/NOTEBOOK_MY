...
**Контейнер** - приложение + библиотеки, полностью изолирован от ОС Linux. Сам контейнер, по сути, содержит операционную систему, за ислючением самого ядра и некоторых низкоуровневых компонентов
...
* Образ имеет слоеную стркутуру: 1 слой - базовый, остальные - изменения в него
...
-p 80:80 -v /var/www/html:/usr/share/nginx/html nginx
  ...
  * -p 80:80 - проброс портов для работы в режиме "Bridge"
