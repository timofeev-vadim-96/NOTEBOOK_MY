...
## **Архитектурные паттерны** в программировании - общие решения для построения структуры проектов:  
...
p.s. Приложение (его классы) должны быть допиливаемыми. Это значит, что мы не должны лезть в прод, но должна быть возможность добавления новой функциональности.
