...
* продолжение процесса до момент создания "полной" системы
...
2. Планирование итерации (команда планирует объем работ на планируемую итерацию)
...
● Разработчики постоянно в контакте
● с заказчиком
● Нет жестких рамок = ПО постоянно изменяется и улучшается
● Заказчик и пользователь партнёры
● и идейные вдохновители
...
* делим проект на спринты (итерации длиной в 1-3 недели)
* при планировании спринта определяются функционал и возможности ИТ-продукта
...
- ценности
  ...
  * открытость (Openess) - общение с заказчиком, общение в команде, новые иде и лучшие практики приветствуются
...
- 3 основные роли в команде: 
  ...
  2. команда разработчиков (Delivery Team)
  3. SCRUM-мастер/коуч - менеджер, а не авторитарный управленец
